...
### 2.2.1 Hierarchical clustering words by sentiments
...
```
Since our data set comprises of text data, we make a corpus and utilize Hierarchical clustering technique. This technique gives us a dendrogram of different words grouped together by sentiments.
...
**Observation:** From all the above graphs, we observe that
...
**observation:** From the RQA graph, it is interpreted that
...
### Number of Tweets over 3 Months
